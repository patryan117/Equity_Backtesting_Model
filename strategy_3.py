...
"Strategy 3:  Buy on next day (n+1) if  Δsp is < (μ – kσ), sell on following day at opening price"
...
def calc_return(w, k, investment, index_df):
    ...
    for i in micro_cap_list:
        ...
        "Strategy 3:  Buy on next day (close)(n+1) if  Δsp is < (μ – kσ), sell on following day at opening price"
        ...
        if i == "ABEO":
            stock_df.to_csv(i + "_strategy_3.csv")
